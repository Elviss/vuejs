...
exports.default = {
    ...
    computed: {
        ...
        filteredAndOrdered: function filteredAndOrdered() {
            ...
            var result = _.orderBy(this.mutatedUsers, this.sortProperty, this.sortDirection);

            if (_.isEmpty(this.filterTerm)) {
                return result;
            }

            return _.filter(result, function (mutatedUsers) {
                return mutatedUsers.name.indexOf(_this.filterTerm) >= 0;
            });
        }
    },
    mounted: function mounted() {
        ...
        this.$http.get('/api/users').then(function (req) {
            return _this2.mutatedUsers = req.data;
        });
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f0a3602e", module.exports)
  } else {
    hotAPI.update("_v-f0a3602e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"lodash":2,"vue":6,"vue-hot-reload-api":4,"vueify/lib/insert-css":7}],9:[function(require,module,exports){
'use strict';
...
},{"./components/users.vue":8,"vue":6,"vue-resource":5}]},{},[9]);
